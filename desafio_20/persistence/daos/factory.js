...
export const selectedFactory = new factorySwitcher(
  CartsFileDAO("./fileDB/carts.json"),
  MessagesFileDAO("./fileDB/messages.json"),
  ProductsFileDAO("./fileDB/products.json"),
  UsersFileDAO("./fileDB/users.json")
)
